...
import io.lokopay.param.EventListParams;
import io.lokopay.param.EventRetrieveParams;
...
public class Event extends ApiResource implements HasId {
  ...
  /**
   * The Loko API version used to render {@code data}. This property is populated only for events
...
//            ApiMode.V1
   ...
   */
  public static Event retrieve(String id) throws LokoException {
   ...
   * have received in a webhook.
   */
  public static Event retrieve(String id, RequestOptions options) throws LokoException {
...
//    return new EventDataObjectDeserializer(apiVersion, type, data.object, getResponseGetter());
  ...
  @Setter
  @EqualsAndHashCode(callSuper = false)
  public static class Data extends LokoObject implements LokoActiveObject {
    /**
     ...
     * elements, this object contains the entire array. In Loko API versions 2017-04-06 or
    ...
    /**
     * Raw JSON object intended to be deserialized as {@code LokoObject}. The deserialization
    ...
    /**
     * @deprecated Deprecated in favor of getting {@code LokoObject} from {@link
     ...
     * @return Deserialized LokoObject for event data.
     */
//    @Deprecated
//    public LokoObject getObject() {
//      return LokoObject.deserializeLokoObject(object, this.responseGetter);
//    }
  ...
  @Setter
  @EqualsAndHashCode(callSuper = false)
  public static class Request extends LokoObject implements HasId {
    /**
